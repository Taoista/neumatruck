...
// echo $n_cotizacion.'<br>';
// echo $valor_apagar."<br>";
// print_r($_SESSION["array_cotizacion"]);
...
// * certifiaco para testing
//  !deprecated la forma de testeo
// $bag = CertificationBagFactory::integrationWebpayNormal();
// Genera Keys para la "Produccion"
// * certificado oriiganl puesta produccion
...
$response = $webpay->initTransaction('https://neumatruck.cl/webpayretorno.php', 'https://neumatruck.cl/webpayfinal.php'); 
